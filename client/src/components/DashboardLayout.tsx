...
import { LayoutDashboard, LogOut, PanelLeft, Users, Bot, MessageSquare, Settings2, Zap, User, UserPlus, Crown, Globe, Coins, Target, Link2, Cpu, Brain, MessageCircle, CreditCard } from "lucide-react";
...
const menuItems = [
  ...
  { icon: CreditCard, label: "マイカード", path: "/cards" },
