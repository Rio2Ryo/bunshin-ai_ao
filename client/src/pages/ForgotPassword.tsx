...
export default function ForgotPassword() {
  ...
  usePageMeta({ title: t("forgotPassword.title"), description: "パスワードをお忘れの方は、メールアドレスを入力してリセットリンクを受け取ってください。", path: "/forgot-password" });
      ...
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl">{t("forgotPassword.sent")}</CardTitle>
            <CardDescription>
